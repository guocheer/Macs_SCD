...
class CSCDNet_arch(nn.Module):
    def __init__(self, outc, corr=False):
        super(CSCDNet_arch, self).__init__()

        self.corr = corr

        # encoder1
        self.enc1_conv1 = nn.Conv2d(3, 64, 7, padding=3, stride=2, bias=False)
        ...
        # encoder2
        self.enc2_conv1 = nn.Conv2d(3, 64, 7, padding=3, stride=2, bias=False)
